...
const SideBar = ({ canvasData, createCanvasClick, clearCanvasClick, undoClick, redoClick, onUploadImage, saveAsPNG, saveCanvasState }) => {
    return (
        <div className='w-1/6 min-h-screen flex flex-col items-center p-2 border-r-2 border-purple-900'>
            ...
            <button onClick={createCanvasClick} className='w-2/3 bg-purple-700 m-2'>Create new canvas</button>
            {
                ...
                <>
                    ...
                    <button onClick={saveCanvasState} className='w-2/3 bg-purple-700 m-2'>Save state</button>
