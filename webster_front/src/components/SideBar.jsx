...
const SideBar = ({ canvasData, createCanvasClick, clearCanvasClick, undoClick, redoClick, addImageToCanvas, setBackgroundImage, exportAsImage, saveCanvasState, restoreCanvasState, onChangeBGColor }) => {
    return (
